  ...
  return (
    <div className='flex flex-col md:flex-row py-16 justify-between items-center gap-12'>
        <div className='md:w-1/2 w-full'>
              ...
              <button className='bg-yellow-500 px-12 py-2 rounded-md text-base  font-bold hover:bg-black hover:text-white transition-all duration-200 cursor-pointer'>Subscribe</button>
        </div>
